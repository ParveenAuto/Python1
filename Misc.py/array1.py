# Que1 take a list with combination of 10 alaphabet and 
# numbers and print all data one by one starting from 2nd no to second last number
# Solution
...
# Que2 Given two arrays arr1[] and arr2[], the task is to find the 
...
# Que3 Given an array, arr of n integers, and an integer element x, 
